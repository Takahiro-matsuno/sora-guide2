package com.jalinfotec.kankoannai.wikitude.util;
...
public final class DropDownAlert {
    ...
    private final FrameLayout alertImagesLayout;
    // todo 置き換え　private final FlexboxLayout alertImagesLayout;
    // https://stackoverflow.com/questions/53709146/failed-to-resolve-com-google-androidflexbox1-1-0
    ...
    private void addImage(String path) {
        /** todo 置き換え
        FlexboxLayout.LayoutParams layoutParams = new FFlexboxLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dpToPx(40));
        layoutParams.setMargins(0, 0, dpToPx(2), dpToPx(2));
         */
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dpToPx(40));
        layoutParams.setMargins(0, 0, dpToPx(2), dpToPx(2));
