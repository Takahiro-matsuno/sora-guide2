package com.jalinfotec.kankoannai.wikitude.util.adapter;
...
public class SamplesExpendableListAdapter extends BaseExpandableListAdapter {
    ...
    public SamplesExpendableListAdapter(@NonNull Context context, @NonNull ArrayList<SampleCategory> sampleCategories) {
